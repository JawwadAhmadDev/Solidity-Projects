...
contract Crypto_TENCARD is Ownable {
    ...
    constructor(IBEP20 _Token) {
        Token = _Token;
        cardPrice[1] = 50000000000000000000;
        cardPrice[2] = 60000000000000000000;
        cardPrice[3] = 70000000000000000000;
        cardPrice[4] = 75000000000000000000;
        cardPrice[5] = 80000000000000000000;
        cardPrice[6] = 90000000000000000000;
        cardPrice[7] = 100000000000000000000;
        cardPrice[8] = 200000000000000000000;
        cardPrice[9] = 500000000000000000000;
        cardPrice[10] = 1000000000000000000000;
    }

    uint256[100] card_probability = [
        1,
        1,
        1,
        1,
    ...
    function UserInfo(
        ...
        view
        returns (
            uint256[] memory usersAmount,
            uint256[] memory usersCardNo,
            uint256[] memory usersCardPrice
        )
    {
